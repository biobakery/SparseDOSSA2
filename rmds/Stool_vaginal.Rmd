...
# Registry
# batchtools::makeRegistry(file.dir = "reg/Stool_vaginal/", package = "magrittr")
batchtools::loadRegistry(file.dir = "reg/Stool_vaginal", writeable = TRUE)
...
one_job <- function(i_job) {
  ...
  # fit SparseDOSSA
  time_start <- Sys.time()
  fit_EM <- SparseDOSSA2:::EM_diagnose_CV(
    data = x_samples,
